...
# #F3
# F2=Fluxmeter(name = "Fluxmeter_2", channel = 1, rate = 269/1000000, is_simulation=simulation)

# #F4
# # F4=Fluxmeter(name = "Fluxmeter_1", channel = 3, rate = 119/1000000, is_simulation= simulation)


# F6=Fluxmeter(name = "Fluxmeter_6", channel = 0, rate = 132/1000000, is_simulation=simulation)

# F3=Fluxmeter(name = "Fluxmeter_3", channel = 2, rate = 284/1000000, is_simulation= simulation)
