            ...
            while compteur_ecriture<5 and i<(context.l):
                ...
                try:
                    ...
                    while Time.monotonic() - absolute_time < i*60 :
                        ...
                        fichier_acq.write(current_time+";"+str(context._Pbat_th[-1])+";"+str(context._Pbat_r[-1])+";"+str(context._PBC_th[-1])+";"+str(context._PBC_r[-1])+";"+str(context._vit[-1])+";"+str(sum(context._P1_moy)/len(context._P1_moy))+";"+str(sum(context._T1_moy)/len(context._T1_moy))+";"+str(sum(context._T2_moy)/len(context._T2_moy))+";"+str(sum(context._T3_moy)/len(context._T3_moy))+";"+str(context._T_asp[-1])+";"+str(sum(context._Ts_moy)/len(context._Ts_moy))+";"+str(sum(context._Tm_moy)/len(context._Tm_moy))+";"+str(sum(context._PyrA_moy)/len(context._PyrA_moy))+";"+str(sum(context._PyrB_moy)/len(context._PyrB_moy))+";"+str(sum(context._F1_moy)/len(context._F1_moy))+";"+str(sum(context._F2_moy)/len(context._F2_moy))+";"+str(sum(context._F3_moy)/len(context._F3_moy))+";"+str(sum(context._F4_moy)/len(context._F4_moy))+";"+str(sum(context._F5_moy)/len(context._F5_moy))+";"+str(sum(context._F6_moy)/len(context._F6_moy))+";"+str(sum(context._F7_moy)/len(context._F7_moy))+";"+str(sum(context._F8_moy)/len(context._F8_moy))+"\n")
